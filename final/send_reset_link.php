    ...
    if(! $messages["errors"] ){
        ...
        if(mysqli_num_rows($result) == 1){
            ...
            if(mysqli_affected_rows($link) == 1){
                ...
                $message_text = '
A password reset request has been made for your Black Orchid account that uses this e-mail address.  If you did not initiate this request, please notify the security team at once.
